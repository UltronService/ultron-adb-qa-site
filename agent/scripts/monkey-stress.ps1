...
& $adb shell monkey -p $env:PACKAGE_NAME --ignore-crashes --ignore-timeouts --ignore-security-exceptions --pct-syskeys 0 $events 2>&1 | Out-Null

Start-Sleep -Seconds 2
$logSnippet = & $adb logcat -d -t 200 2>&1
